return {
    ...
    event = "VimEnter", --load eagerly
    config = function()
        require("pets").setup({
            -- your options here

            row = 5,                        -- the row (height) to display the pet at (must be at least 1 and at most 10)
            ...
            popup = {                       -- popup options, try changing these if you see a rectangle around the pets
                width = "40",               -- can be a string with percentage like "45%" or a number of columns like 45
